...
const PropertyPage = ({
  ...
  const handleWhatsAppInquiry = () => {
    const message = `Hello! I'm interested in the below property: *Property Name*: ${
      propertyData?.title
    } *Property Code*: #${
      propertyData.id
    } *Price*: ₹${propertyData?.price.toLocaleString()} *Location*: ${
      propertyData?.city
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Connect directly with our team via WhatsApp, or call for
              more details or to schedule a visit.
            </p>
          </div>
          <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
            <Button
              className="bg-premium-gradient text-black w-full md:w-auto"
            ...
            <Button
              variant={'default'}
              className="bg-white hover:bg-slate-600 text-black w-full md:w-auto"
              asChild
            >
              <a href="tel:+918310666162">
